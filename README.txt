...
#### Drop-Down menus
On the top, right hand side of the board there are five drop-down menus: Language, Type of contact, Template, Company and FPI (i.e. full protection insurance). Note that this version of the program does not contain all the templates for security reasons.  To search for available templates:
